...
var header = {
  ...
  salary: '600$ в місяць',
  address: 'Вулиця Шевченка, 12, м. Київ, Україна',
}
          ...
          projects: [
            {
              ...
              awards: [
                ...
                {
                  name: 'Prepering SEO optimized pages. The automated process of getting data for the app from documents.',
                },
              ],
              stackAmount: 3,
              awardAmount: 2,
...
router.get('/bootstrap_old', function (req, res) {
  //             ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrap_old', {
    layout: 'bootstrap',
  })
  // ↙ сюди вводимо JSON дані
})
